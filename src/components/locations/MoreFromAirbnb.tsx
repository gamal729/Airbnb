...
const MoreFromAirbnb = () => {
    return (
        <div className="py-12 border-b border-neutral-200">
            <h2 className="text-2xl font-bold mb-8 text-neutral-800 text-center">المزيد من Airbnb</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="relative h-[300px] rounded-2xl overflow-hidden cursor-pointer group">
                    ...
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-8 text-white">
                        <h3 className="text-2xl font-bold mb-2">الخدمات على Airbnb</h3>
                ...
                <div className="relative h-[300px] rounded-2xl overflow-hidden cursor-pointer group">
                    ...
                    />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-8 text-white">
                        <h3 className="text-2xl font-bold mb-2">تجارب السفر على Airbnb</h3>
